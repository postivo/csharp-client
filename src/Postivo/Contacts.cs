...
namespace Postivo
{
    ...
    public class Contacts: IContacts
    {
        ...
        public async Task<ListContactsResponse> ListAsync(long? page = 1, long? limit = 10, RetryConfig? retryConfig = null, CancellationToken? cancellationToken = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "listContacts", null, SDKConfiguration.SecuritySource, cancellationToken);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    List<ContactResponse> obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<List<ContactResponse>>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into List<ContactResponse>.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
            ...
            else
            {
                if(Utilities.IsContentTypeMatch("application/problem+json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<Models.Components.ErrorResponse>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
        ...
        public async Task<AddContactResponse> AddAsync(Contact request, RetryConfig? retryConfig = null, CancellationToken? cancellationToken = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "addContact", null, SDKConfiguration.SecuritySource, cancellationToken);
        ...
        public async Task<GetContactByIdResponse> GetAsync(long id, RetryConfig? retryConfig = null, CancellationToken? cancellationToken = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "getContactById", null, SDKConfiguration.SecuritySource, cancellationToken);
        ...
        public async Task<UpdateContactResponse> UpdateAsync(long id, Contact contact, RetryConfig? retryConfig = null, CancellationToken? cancellationToken = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "updateContact", null, SDKConfiguration.SecuritySource, cancellationToken);
        ...
        public async Task<DeleteContactResponse> DeleteAsync(long id, RetryConfig? retryConfig = null, CancellationToken? cancellationToken = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "deleteContact", null, SDKConfiguration.SecuritySource, cancellationToken);
        ...
        public async Task<RemoveContactFromGroupResponse> RemoveFromGroupAsync(long id, long groupId, RetryConfig? retryConfig = null, CancellationToken? cancellationToken = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "removeContactFromGroup", null, SDKConfiguration.SecuritySource, cancellationToken);
            ...
            if(responseStatusCode == 204)
            {
                return new RemoveContactFromGroupResponse()
                {
                    HttpMeta = new Models.Components.HTTPMetadata()
                    {
                        Response = httpResponse,
            ...
            else
            {
                if(Utilities.IsContentTypeMatch("application/problem+json", contentType))
                {
                    ...
                    var response = new RemoveContactFromGroupResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
        ...
        public async Task<AddContactToGroupResponse> AddToGroupAsync(long id, long groupId, RetryConfig? retryConfig = null, CancellationToken? cancellationToken = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "addContactToGroup", null, SDKConfiguration.SecuritySource, cancellationToken);
            ...
            if(responseStatusCode == 204)
            {
                return new AddContactToGroupResponse()
                {
                    HttpMeta = new Models.Components.HTTPMetadata()
                    {
                        Response = httpResponse,
            ...
            else
            {
                if(Utilities.IsContentTypeMatch("application/problem+json", contentType))
                {
                    ...
                    var response = new AddContactToGroupResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
