...
namespace Postivo
{
    ...
    public class Metadata: IMetadata
    {
        ...
        public async Task<ListMetadataResponse> ListAsync(RetryConfig? retryConfig = null, CancellationToken? cancellationToken = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "listMetadata", null, SDKConfiguration.SecuritySource, cancellationToken);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<MetadataResponse>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into MetadataResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new ListMetadataResponse()
                    {
        ...
        public async Task<ListPredefinedConfigsResponse> GetPredefinedConfigsAsync(RetryConfig? retryConfig = null, CancellationToken? cancellationToken = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "listPredefinedConfigs", null, SDKConfiguration.SecuritySource, cancellationToken);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var httpResponseBody = await httpResponse.Content.ReadAsStringAsync();
                    List<PredefinedConfig> obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<List<PredefinedConfig>>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into List<PredefinedConfig>.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new ListPredefinedConfigsResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
                    ...
                    response.PredefinedConfigs = obj;
                    return response;
                }
